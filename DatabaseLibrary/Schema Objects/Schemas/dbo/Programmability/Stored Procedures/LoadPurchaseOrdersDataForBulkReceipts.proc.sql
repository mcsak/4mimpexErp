...
CREATE proc [dbo].[LoadPurchaseOrdersDataForBulkReceipts]  
@FilterType tinyint,  
...
begin  
 ...
 case when PO.Status=1 then 'Not received' when PO.Status=2 then 'Partially received' else 'UnPredicted' end as POStatus,  
 ...
 where PO.Status in (1,2) and PO.DeleBy is null  
