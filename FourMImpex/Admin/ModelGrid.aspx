<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="~/Admin/ModelGrid.aspx.cs" Inherits="FourMImpex.Admin.ModelGrid" MasterPageFile="~/InnerMaster.Master" %>

<asp:Content ID="ModelHeadContent" ContentPlaceHolderID="ContentPlaceHolderHead"  runat="server">
    <title>Brand</title>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function isRecordSelected(str) {
            var element = document.getElementById('ctl00_ContentPlaceHolderMain_gvModel').getElementsByTagName('input');
        ...
        <div class="admincontentcontainer">
            ...
            <div class="adminpagegridcontainer">
                ...
                <div class="admingridcontainer">
                    <asp:GridView ID="gvModel" runat="server" Width="100%" PagerStyle-Height="30px"
                        AutoGenerateColumns="false" OnSorting="gvModel_Sorting" OnPageIndexChanging="gvModel_SelectedIndexChanged">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Select" HeaderStyle-Width="5%" ItemStyle-Width="5%"
                                ...
                                <ItemTemplate>
                                    <input type="radio" id="OptID" name="OptID" value='<%#Eval("ModelID")%>' />
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Model Name" HeaderStyle-Width="25%" ItemStyle-Width="25%"
                                HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" SortExpression="ModelName|4">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Description" HeaderStyle-Width="25%" ItemStyle-Width="25%"
                                HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" SortExpression="Description|5">
                                <ItemTemplate>
                                    <asp:Label ID="lblModelDescription" runat="server" Text='<%#Eval("Description") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
