...
{
    public partial class ProductPriceGrid : System.Web.UI.Page
    {
                ...
                if (ds != null)
                {
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        if (ViewState["SortColIndex"].ToString() != "")
                        {
                            ...
                            gvProductPrice.HeaderRow.Cells[Convert.ToInt16(ViewState["SortColIndex"].ToString())].Controls.Add(imgSort);
                        }
                    }
                    else
                    {
                        gvProductPrice.Visible = false;
        ...
        protected void gvProductPrice_Sorting(object sender, GridViewSortEventArgs e)
        {
            ...
            if (ViewState["SortColIndex"].ToString() != "")
            {
                ...
                gvProductPrice.HeaderRow.Cells[Convert.ToInt16(ViewState["SortColIndex"])].Controls.Add(imgSort);
            }
        }
        protected void gvProductPrice_SelectedIndexChanged(object sender, GridViewPageEventArgs e)
        {
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("~/Admin/ProductPrice.aspx?RID=" + RId + "&op=2");
        }
