<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="~/Admin/ProductGrid.aspx.cs" Inherits="FourMImpex.Admin.ProductGrid" MasterPageFile="~/InnerMaster.Master" %>
...
<asp:Content ID="ProductHeadContent" ContentPlaceHolderID="ContentPlaceHolderHead"
    ...
    <script language="javascript" type="text/javascript">
        ...
        function isRecordSelected(str) {
            var element = document.getElementById('ctl00_ContentPlaceHolderMain_gvProduct').getElementsByTagName('input');
...
<div class="admincontentcontainer">
    ...
    <div class="adminpagetitlecontainer">Product</div>
    <div class="adminpagegridcontainer">
        ...
        <div class="admingridcontainer">
            <asp:GridView ID="gvProduct" runat="server" Width="100%" PagerStyle-Height="30px"
                AutoGenerateColumns="false" OnPageIndexChanging="gvProduct_SelectedIndexChanged"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Select" HeaderStyle-Width="5%" ItemStyle-Width="5%"
                        ...
                        <ItemTemplate>
                            <input type="radio" id="OptID" name="OptID" value='<%#Eval("ProductID")%>' />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Product Name" HeaderStyle-Width="40%" ItemStyle-Width="40%"
