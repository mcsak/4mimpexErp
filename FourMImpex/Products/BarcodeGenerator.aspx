                        ...
                        <asp:GridView ID="GvCurrentStockReport" CssClass="GridViewStyle" runat="server" EnableTheming="false" 
                           ...
                           <HeaderStyle BackColor="#02498d" ForeColor="White" Font-Size="Medium" />
                            <Columns>
                                ...
                                <asp:BoundField DataField="Barcode" ItemStyle-HorizontalAlign="center" HeaderStyle-HorizontalAlign="center"
                                    HeaderText="Barcode" HeaderStyle-Width="100px" ItemStyle-Width="100px"></asp:BoundField>
