<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="~/Reports/SalesReceiptReport.aspx.cs"
    Inherits="FourMImpex.Reports.SalesReceiptReport" MasterPageFile="~/InnerMaster.Master" %>

<asp:Content ID="PurchaseOrderHeadContent" ContentPlaceHolderID="ContentPlaceHolderHead"
    runat="server">
    <title>Sales Receipt Report</title>
