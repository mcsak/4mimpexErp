<%@ Page Title="Bulk Receipt Grid" Language="C#" AutoEventWireup="true" CodeBehind="~/Stocks/BulkReceiptGrid.aspx.cs" Inherits="FourMImpex.Stocks.BulkReceiptGrid" MasterPageFile="~/InnerMaster.Master" %>

<asp:Content ID="BulkReceiptHeadContent" ContentPlaceHolderID="ContentPlaceHolderHead" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function isRecordSelected(str) {
            var element = document.getElementById('ctl00_ContentPlaceHolderMain_GVBulkReceipts').getElementsByTagName('input');
...
<asp:Content ID="BulkReceiptMainContent" ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
    <div class="centeroutercontainer">
        ...
        <div class="admingridcontainer">
            <asp:UpdatePanel ID="Updpnl" runat="server">
                <ContentTemplate>
                    <asp:GridView ID="GVBulkReceipts" runat="server" Width="90%" PagerStyle-Height="30px"
                        AutoGenerateColumns="false" OnSorting="GVBulkReceipts_Sorting" OnPageIndexChanging="GVBulkReceipts_SelectedIndexChanged">
                        <Columns>
